...
class AuthService:
    ...
    async def register(self, user_data: UserCreate, created_by: str = None, organization_id: str = None) -> UserResponse:
    ...
    async def login(self, login_data: LoginRequest) -> TokenResponse:
        ...
        if user.organization_id:
            ...
            if not org or not org.is_active:
                raise ValueError("Organization is inactive or disabled")
