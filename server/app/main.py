...
from app.routers import auth, computers, policies, commands, audit, reports, messages, monitoring, agent_updates, organizations, internet, firewall, helpdesk, vpn, network, active_directory, computer_management, security, education, ai_assistant, enterprise
    ...
    while True:
        try:
            ...
            async with async_session() as db:
                triggered = await alert_service.check_rules(metrics, db)
            if triggered:
...
app.include_router(computer_management.router)
